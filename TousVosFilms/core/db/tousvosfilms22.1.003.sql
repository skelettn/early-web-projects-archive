...
--
-- Hôte : localhost:3306
-- Généré le : mar. 13 sep. 2022 à 19:50
...
(39, '9f80f66f9af4c8640489e20a48d81626', 'Bobyy', 'harry-potter-et-les-reliques-de-la-mort-partie-2', 'Harry Potter et les reliques de la mort - Partie 2', 'movie', 'harry-potter-et-les-reliques-de-la-mort-partie-2.jpg'),
(40, '9f80f66f9af4c8640489e20a48d81626', 'Place', 'thor-love-and-thunder', 'Thor: Love and Thunder', 'movie', 'thor-love-and-thunder.jpg');
...
(14, '9f80f66f9af4c8640489e20a48d81626', 'Bobyy', 'randm-1'),
(15, '9f80f66f9af4c8640489e20a48d81626', 'Kiki', 'randm-2'),
(16, '9f80f66f9af4c8640489e20a48d81626', 'Couc', 'breaking-bad-7'),
...
--
-- Structure de la table `tvf_plus`
--

CREATE TABLE `tvf_plus` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `tvf_plus`
--

INSERT INTO `tvf_plus` (`id`, `uid`, `subscription_start`, `subscription_end`) VALUES
(1, '9f80f66f9af4c8640489e20a48d81626', 1663003600, 1665595600);
...
INSERT INTO `users` (`id`, `unique_id`, `email`, `username`, `tvf_coin`, `tvf_plus`, `avatar`, `level`) VALUES
(1, '9f80f66f9af4c8640489e20a48d81626', 'user@example.com', 'Shonned', 2147483447, 1, '', 4),
(2, '50adb554a0416febfdb5400990ef5994', 'user@example.com', 'Shon2', 0, 0, '', 0),
(3, '7077219b0dc4d03535d07091647ddb65', 'user@example.com', 'meetcomett', 0, 0, '', 0),
(4, '07c4779ef18f667deb5f7d3249d1493d', 'user@example.com ', 'juju', 0, 0, '', 0),
(5, '8fda271b76c953bf222b9384e9cdcfb7', 'user@example.com', '200000', 0, 0, '', 0);
...
--
-- Index pour la table `tvf_plus`
--
ALTER TABLE `tvf_plus`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `tvf_plus`
--
ALTER TABLE `tvf_plus`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
