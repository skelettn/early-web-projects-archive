...
<body>
  ...
  <div class="bg-movie bg-movie-home" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgb(26, 29, 41) 100%), url('https://i.pinimg.com/originals/61/aa/7d/61aa7d83a01c5e64d40dc04227ac0036.jpg');">
      ...
      <section class="banner">
        <div class="banner-card">
          <div class="card-content">
            <h2 class="card-title"><img src="https://upload.wikimedia.org/wikipedia/commons/7/79/Ted_logo.png"></h2>
            <div class="card-btn">
              <a href="video/ted">Lecture <ion-icon name="open-outline"></ion-icon></a>
              <a href="video/ted">Plus d'infos</a>
            </div>
          </div>
        </div>
      </section>
  ...
  <div class="container">
      ...
      <section class="movies">
        ...
        <div class="movies-grid">
          <a href="video/spirale-l-heritage-de-saw">
              <div class="movie-card">
                <div class="card-head">
                  <img src="assets/images/cover/saw9.jpg" alt="Spirale L'Héritage de Saw" class="card-img">
                  <div class="card-overlay">
                    <div class="rating">
                      <ion-icon name="star-outline"></ion-icon>
                      <span>7.5</span>
                ...
                <div class="card-body">
                  <h3 class="card-title">Spirale L'Héritage de Saw</h3>
                  <div class="card-info">
                    <span class="year">2021</span>
                  </div>
                </div>
            ...
            <a href="video/ca-chapitre-2">
              <div class="movie-card">
                <div class="card-head">
                  <img src="assets/images/cover/ca-chapitre-2.jpg" alt="Ça : Chapitre 2" class="card-img">
                  <div class="card-overlay">
                    <div class="rating">
                      <ion-icon name="star-outline"></ion-icon>
                      <span>8.3</span>
                ...
                <div class="card-body">
                  <h3 class="card-title">Ça : Chapitre 2</h3>
                  <div class="card-info">
      ...
      <section class="movies" id="marvel">
        ...
        <div class="movies-grid">
          ...
          <a href="video/venom-2">
            ...
            <a href="video/spider-man-far-from-home">
              <div class="movie-card">
                <div class="card-head">
                  <img src="assets/images/cover/spider-man-far-from-home.jpg" alt="Spider-Man: Far From Home" class="card-img">
                  <div class="card-overlay">
                    <div class="rating">
                      <ion-icon name="star-outline"></ion-icon>
                      <span>8.5</span>
                ...
                <div class="card-body">
                  <h3 class="card-title">Spider-Man: Far From Home</h3>
                  <div class="card-info">
                    <span class="year">2019</span>
                  </div>
                </div>
